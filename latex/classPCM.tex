...
\item 
enum {\bf Program\+Mode} \{ {\bf D\+E\+F\+A\+U\+L\+T\+\_\+\+E\+V\+E\+N\+TS} = 0, 
{\bf C\+U\+S\+T\+O\+M\+\_\+\+C\+O\+R\+E\+\_\+\+E\+V\+E\+N\+TS} = 1, 
{\bf E\+X\+T\+\_\+\+C\+U\+S\+T\+O\+M\+\_\+\+C\+O\+R\+E\+\_\+\+E\+V\+E\+N\+TS} = 2, 
{\bf I\+N\+V\+A\+L\+I\+D\+\_\+\+M\+O\+DE}
...
{\bf Error\+Code} {\bf program} (const {\bf Program\+Mode} mode\+\_\+={\bf D\+E\+F\+A\+U\+L\+T\+\_\+\+E\+V\+E\+N\+TS}, const void $\ast$parameter\+\_\+=N\+U\+LL)
\begin{DoxyCompactList}\small\item\em Programs performance counters. \end{DoxyCompactList}\item 
{\bf Error\+Code} {\bf program\+Server\+Uncore\+Power\+Metrics} (int mc\+\_\+profile, int pcu\+\_\+profile, int $\ast$freq\+\_\+bands=N\+U\+LL)
...
{\bf Error\+Code} {\bf program\+Server\+Uncore\+Memory\+Metrics} (int rankA=-\/1, int rankB=-\/1)
...
size\+\_\+t {\bf get\+M\+C\+Channels\+Per\+Socket} () const \label{classPCM_ab2952d885f0817b545d360e259c36c17}
...
uint64 {\bf get\+Tick\+Count\+R\+D\+T\+S\+CP} (uint64 multiplier=1000)
...
\item 
uint64 {\bfseries extract\+Q\+O\+S\+Monitoring} (uint64 val)\label{classPCM_ab42f103a8df6035c075f022d6c7de04d}
...
std\+::string {\bfseries get\+C\+P\+U\+Family\+Model\+String} ()\label{classPCM_aa593d2445c7c96ebcb2e37222c2d8ff4}
...
\item 
bool {\bfseries incoming\+Q\+P\+I\+Traffic\+Metrics\+Available} () const \label{classPCM_aaece4a236fe7ded259693edfb5ba5202}
...
\item 
bool {\bfseries supports\+H\+LE} () const \label{classPCM_abe25facd837008c142ddff69f27632e1}

\item 
bool {\bfseries supports\+R\+TM} () const \label{classPCM_ad5310e03ffc2081d06af4c9e2e2fb9cb}

\item 
bool {\bfseries use\+Skylake\+Events} () const \label{classPCM_ad3ef40a0685e53f176b3681a3060345c}

\end{DoxyCompactItemize}
\subsection*{Static Public Member Functions}
\begin{DoxyCompactItemize}
\item 
static {\bf P\+CM} $\ast$ {\bf get\+Instance} ()
...
\item[Enumerator]\par
\begin{description}
\index{D\+E\+F\+A\+U\+L\+T\+\_\+\+E\+V\+E\+N\+TS@{D\+E\+F\+A\+U\+L\+T\+\_\+\+E\+V\+E\+N\+TS}!P\+CM@{P\+CM}}\index{P\+CM@{P\+CM}!D\+E\+F\+A\+U\+L\+T\+\_\+\+E\+V\+E\+N\+TS@{D\+E\+F\+A\+U\+L\+T\+\_\+\+E\+V\+E\+N\+TS}}\item[{\em 
D\+E\+F\+A\+U\+L\+T\+\_\+\+E\+V\+E\+N\+TS\label{classPCM_a88584813a3ef51376efeb22928764786a0e861144f482697cfa423b012ed42451}
}]Default choice of events, the additional parameter is not needed and ignored \index{C\+U\+S\+T\+O\+M\+\_\+\+C\+O\+R\+E\+\_\+\+E\+V\+E\+N\+TS@{C\+U\+S\+T\+O\+M\+\_\+\+C\+O\+R\+E\+\_\+\+E\+V\+E\+N\+TS}!P\+CM@{P\+CM}}\index{P\+CM@{P\+CM}!C\+U\+S\+T\+O\+M\+\_\+\+C\+O\+R\+E\+\_\+\+E\+V\+E\+N\+TS@{C\+U\+S\+T\+O\+M\+\_\+\+C\+O\+R\+E\+\_\+\+E\+V\+E\+N\+TS}}\item[{\em 
C\+U\+S\+T\+O\+M\+\_\+\+C\+O\+R\+E\+\_\+\+E\+V\+E\+N\+TS\label{classPCM_a88584813a3ef51376efeb22928764786ac092b2b5f351e33046b87e5cee31f38f}
}]Custom set of core events specified in the parameter to the program method. The parameter must be a pointer to array of four {\ttfamily \doxyref{Custom\+Core\+Event\+Description}{p.}{structPCM_1_1CustomCoreEventDescription}} values \index{E\+X\+T\+\_\+\+C\+U\+S\+T\+O\+M\+\_\+\+C\+O\+R\+E\+\_\+\+E\+V\+E\+N\+TS@{E\+X\+T\+\_\+\+C\+U\+S\+T\+O\+M\+\_\+\+C\+O\+R\+E\+\_\+\+E\+V\+E\+N\+TS}!P\+CM@{P\+CM}}\index{P\+CM@{P\+CM}!E\+X\+T\+\_\+\+C\+U\+S\+T\+O\+M\+\_\+\+C\+O\+R\+E\+\_\+\+E\+V\+E\+N\+TS@{E\+X\+T\+\_\+\+C\+U\+S\+T\+O\+M\+\_\+\+C\+O\+R\+E\+\_\+\+E\+V\+E\+N\+TS}}\item[{\em 
E\+X\+T\+\_\+\+C\+U\+S\+T\+O\+M\+\_\+\+C\+O\+R\+E\+\_\+\+E\+V\+E\+N\+TS\label{classPCM_a88584813a3ef51376efeb22928764786a0f2ff80b85b8f9483c7f03544f73fcbd}
}]Custom set of core events specified in the parameter to the program method. The parameter must be a pointer to a {\ttfamily \doxyref{Extended\+Custom\+Core\+Event\+Description}{p.}{structPCM_1_1ExtendedCustomCoreEventDescription}} data structure \index{I\+N\+V\+A\+L\+I\+D\+\_\+\+M\+O\+DE@{I\+N\+V\+A\+L\+I\+D\+\_\+\+M\+O\+DE}!P\+CM@{P\+CM}}\index{P\+CM@{P\+CM}!I\+N\+V\+A\+L\+I\+D\+\_\+\+M\+O\+DE@{I\+N\+V\+A\+L\+I\+D\+\_\+\+M\+O\+DE}}\item[{\em 
I\+N\+V\+A\+L\+I\+D\+\_\+\+M\+O\+DE\label{classPCM_a88584813a3ef51376efeb22928764786ad60e2f3b64e27eaaa84d2b07fea8e225}
...
\subsubsection[{Core\+Local\+Memory\+B\+W\+Metric\+Available()}]{\setlength{\rightskip}{0pt plus 5cm}bool P\+C\+M\+::\+Core\+Local\+Memory\+B\+W\+Metric\+Available (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}\label{classPCM_a679962a820b4f0b317895d770a7c0f57}
...
\subsubsection[{Core\+Remote\+Memory\+B\+W\+Metric\+Available()}]{\setlength{\rightskip}{0pt plus 5cm}bool P\+C\+M\+::\+Core\+Remote\+Memory\+B\+W\+Metric\+Available (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}\label{classPCM_ac642929af03601d7e037846370b7a68d}
...
\subsubsection[{get\+All\+Counter\+States(\+System\+Counter\+State \&system\+State, std\+::vector$<$ Socket\+Counter\+State $>$ \&socket\+States, std\+::vector$<$ Core\+Counter\+State $>$ \&core\+States)}]{\setlength{\rightskip}{0pt plus 5cm}void P\+C\+M\+::get\+All\+Counter\+States (
\begin{DoxyParamCaption}
...
\subsubsection[{get\+Core\+Counter\+State(uint32 core)}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Core\+Counter\+State} P\+C\+M\+::get\+Core\+Counter\+State (
\begin{DoxyParamCaption}
\item[{uint32}]{core}
\end{DoxyParamCaption}
...
Referenced by get\+Core\+Counter\+State(), get\+Cycles\+Lost\+Due\+L2\+Cache\+Misses(), get\+Cycles\+Lost\+Due\+L3\+Cache\+Misses(), get\+D\+R\+A\+M\+Consumed\+Joules(), get\+L2\+Cache\+Hit\+Ratio(), get\+L2\+Cache\+Hits(), get\+L2\+Cache\+Misses(), get\+L3\+Cache\+Hit\+Ratio(), get\+L3\+Cache\+Hits(), get\+L3\+Cache\+Hits\+No\+Snoop(), get\+L3\+Cache\+Hits\+Snoop(), get\+L3\+Cache\+Misses(), Server\+P\+C\+I\+C\+F\+G\+Uncore\+::program\+Server\+Uncore\+Memory\+Metrics(), and Server\+P\+C\+I\+C\+F\+G\+Uncore\+::\+Server\+P\+C\+I\+C\+F\+G\+Uncore().

\index{P\+CM@{P\+CM}!get\+Error\+Message@{get\+Error\+Message}}
\index{get\+Error\+Message@{get\+Error\+Message}!P\+CM@{P\+CM}}
\subsubsection[{get\+Error\+Message() const }]{\setlength{\rightskip}{0pt plus 5cm}const std\+::string\& P\+C\+M\+::get\+Error\+Message (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{get\+Instance()}]{\setlength{\rightskip}{0pt plus 5cm}{\bf P\+CM} $\ast$ P\+C\+M\+::get\+Instance (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
Referenced by Server\+P\+C\+I\+C\+F\+G\+Uncore\+::compute\+Q\+P\+I\+Speed(), exit\+\_\+cleanup(), get\+Active\+Average\+Frequency(), get\+All\+Incoming\+Q\+P\+I\+Link\+Bytes(), get\+All\+Outgoing\+Q\+P\+I\+Link\+Bytes(), get\+Average\+Frequency(), get\+Consumed\+Joules(), get\+Core\+Counter\+State(), get\+Core\+C\+State\+Residency(), get\+Core\+I\+P\+C(), get\+Cycles\+Lost\+Due\+L2\+Cache\+Misses(), get\+Cycles\+Lost\+Due\+L3\+Cache\+Misses(), get\+D\+R\+A\+M\+Consumed\+Joules(), get\+Incoming\+Q\+P\+I\+Link\+Bytes(), get\+Incoming\+Q\+P\+I\+Link\+Utilization(), get\+L2\+Cache\+Hit\+Ratio(), get\+L2\+Cache\+Hits(), get\+L2\+Cache\+Misses(), get\+L3\+Cache\+Hit\+Ratio(), get\+L3\+Cache\+Hits(), get\+L3\+Cache\+Hits\+No\+Snoop(), get\+L3\+Cache\+Hits\+Snoop(), get\+L3\+Cache\+Misses(), get\+Outgoing\+Q\+P\+I\+Link\+Bytes(), get\+Outgoing\+Q\+P\+I\+Link\+Utilization(), get\+Socket\+Counter\+State(), get\+Socket\+Incoming\+Q\+P\+I\+Link\+Bytes(), get\+System\+Counter\+State(), get\+Total\+Exec\+Usage(), My\+System(), Server\+P\+C\+I\+C\+F\+G\+Uncore\+::program\+Server\+Uncore\+Memory\+Metrics(), sig\+I\+N\+T\+\_\+handler(), sig\+S\+T\+O\+P\+\_\+handler(), and unfreeze\+Server\+Uncore\+Counters().
...
\subsubsection[{get\+Max\+I\+P\+C() const }]{\setlength{\rightskip}{0pt plus 5cm}uint32 P\+C\+M\+::get\+Max\+I\+PC (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{get\+Max\+R\+M\+I\+D() const }]{\setlength{\rightskip}{0pt plus 5cm}unsigned P\+C\+M\+::get\+Max\+R\+M\+ID (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
Referenced by get\+Active\+Average\+Frequency(), get\+Average\+Frequency(), get\+Core\+Counter\+State(), get\+Incoming\+Q\+P\+I\+Link\+Utilization(), get\+Outgoing\+Q\+P\+I\+Link\+Bytes(), get\+Outgoing\+Q\+P\+I\+Link\+Utilization(), get\+Tick\+Count(), and get\+Tick\+Count\+R\+D\+T\+S\+C\+P().
...
Referenced by get\+Core\+Counter\+State().
...
\subsubsection[{get\+P\+C\+Ie\+Counter\+State(const uint32 socket\+\_\+)}]{\setlength{\rightskip}{0pt plus 5cm}{\bf P\+C\+Ie\+Counter\+State} P\+C\+M\+::get\+P\+C\+Ie\+Counter\+State (
\begin{DoxyParamCaption}
...
\subsubsection[{get\+Q\+P\+I\+Link\+Speed(uint32 socket\+Nr, uint32 link\+Nr) const }]{\setlength{\rightskip}{0pt plus 5cm}uint64 P\+C\+M\+::get\+Q\+P\+I\+Link\+Speed (
\begin{DoxyParamCaption}
...
\subsubsection[{get\+Q\+P\+I\+Links\+Per\+Socket() const }]{\setlength{\rightskip}{0pt plus 5cm}uint64 P\+C\+M\+::get\+Q\+P\+I\+Links\+Per\+Socket (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
Referenced by get\+All\+Incoming\+Q\+P\+I\+Link\+Bytes(), get\+All\+Outgoing\+Q\+P\+I\+Link\+Bytes(), get\+Socket\+Incoming\+Q\+P\+I\+Link\+Bytes(), and get\+System\+Counter\+State().
...
\subsubsection[{get\+Server\+Uncore\+Power\+State(uint32 socket)}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Server\+Uncore\+Power\+State} P\+C\+M\+::get\+Server\+Uncore\+Power\+State (
\begin{DoxyParamCaption}
\item[{uint32}]{socket}
\end{DoxyParamCaption}
...
\subsubsection[{get\+S\+M\+T()}]{\setlength{\rightskip}{0pt plus 5cm}bool P\+C\+M\+::get\+S\+MT (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{get\+Socket\+Counter\+State(uint32 socket)}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Socket\+Counter\+State} P\+C\+M\+::get\+Socket\+Counter\+State (
\begin{DoxyParamCaption}
\item[{uint32}]{socket}
\end{DoxyParamCaption}
...
\subsubsection[{get\+Socket\+Id(uint32 core\+\_\+id)}]{\setlength{\rightskip}{0pt plus 5cm}int32 P\+C\+M\+::get\+Socket\+Id (
\begin{DoxyParamCaption}
...
References get\+Q\+P\+I\+Links\+Per\+Socket(), and is\+Core\+Online().
...
\subsubsection[{get\+Tick\+Count(uint64 multiplier=1000, uint32 core=0)}]{\setlength{\rightskip}{0pt plus 5cm}uint64 P\+C\+M\+::get\+Tick\+Count (
\begin{DoxyParamCaption}
...
Referenced by Server\+P\+C\+I\+C\+F\+G\+Uncore\+::compute\+Q\+P\+I\+Speed(), and get\+C\+P\+U\+Brand\+String().
...
\subsubsection[{get\+Tick\+Count\+R\+D\+T\+S\+C\+P(uint64 multiplier=1000)}]{\setlength{\rightskip}{0pt plus 5cm}uint64 P\+C\+M\+::get\+Tick\+Count\+R\+D\+T\+S\+CP (
\begin{DoxyParamCaption}
\item[{uint64}]{multiplier = {\ttfamily 1000}}
\end{DoxyParamCaption}
...
\subsubsection[{get\+U\+Arch\+Codename(int32 cpu\+\_\+model\+\_\+=-\/1) const }]{\setlength{\rightskip}{0pt plus 5cm}const char $\ast$ P\+C\+M\+::get\+U\+Arch\+Codename (
\begin{DoxyParamCaption}
...
Referenced by get\+C\+P\+U\+Brand\+String().
...
\subsubsection[{is\+Core\+Online(int32 os\+\_\+core\+\_\+id) const }]{\setlength{\rightskip}{0pt plus 5cm}bool P\+C\+M\+::is\+Core\+Online (
\begin{DoxyParamCaption}
...
References get\+C\+P\+U\+Brand\+String().



Referenced by get\+All\+Counter\+States(), get\+Socket\+Counter\+State(), get\+System\+Counter\+State(), and reset\+P\+M\+U().
...
\subsubsection[{L3\+Q\+O\+S\+Metric\+Available()}]{\setlength{\rightskip}{0pt plus 5cm}bool P\+C\+M\+::\+L3\+Q\+O\+S\+Metric\+Available (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}\label{classPCM_a93416f1fb3372dcce2be6a88ed00dff0}
...
Referenced by Core\+Local\+Memory\+B\+W\+Metric\+Available(), Core\+Remote\+Memory\+B\+W\+Metric\+Available(), L3\+Cache\+Occupancy\+Metric\+Available(), and reset\+P\+M\+U().

\index{P\+CM@{P\+CM}!program@{program}}
\index{program@{program}!P\+CM@{P\+CM}}
\subsubsection[{program(const Program\+Mode mode\+\_\+=\+D\+E\+F\+A\+U\+L\+T\+\_\+\+E\+V\+E\+N\+T\+S, const void $\ast$parameter\+\_\+=\+N\+U\+L\+L)}]{\setlength{\rightskip}{0pt plus 5cm}{\bf P\+C\+M\+::\+Error\+Code} P\+C\+M\+::program (
\begin{DoxyParamCaption}
\item[{const {\bf Program\+Mode}}]{mode\+\_\+ = {\ttfamily {\bf D\+E\+F\+A\+U\+L\+T\+\_\+\+E\+V\+E\+N\+TS}}, }
...
\subsubsection[{program\+P\+C\+Ie\+Counters(const P\+C\+Ie\+Event\+Code event\+\_\+, const uint32 tid\+\_\+=0, const uint32 miss\+\_\+=0)}]{\setlength{\rightskip}{0pt plus 5cm}void P\+C\+M\+::program\+P\+C\+Ie\+Counters (
\begin{DoxyParamCaption}
...
\hline
{\em tid\+\_\+} & tid filter (\doxyref{P\+CM}{p.}{classPCM} supports it only on Haswell server) \\
\hline
\end{DoxyParams}
...
\subsubsection[{program\+Server\+Uncore\+Memory\+Metrics(int rank\+A=-\/1, int rank\+B=-\/1)}]{\setlength{\rightskip}{0pt plus 5cm}{\bf P\+C\+M\+::\+Error\+Code} P\+C\+M\+::program\+Server\+Uncore\+Memory\+Metrics (
\begin{DoxyParamCaption}
\item[{int}]{rankA = {\ttfamily -\/1}, }
\item[{int}]{rankB = {\ttfamily -\/1}}
\end{DoxyParamCaption}
)}\label{classPCM_aa2263c70dabe237a8aeb9cdc58736ee5}
...
\subsubsection[{program\+Server\+Uncore\+Power\+Metrics(int mc\+\_\+profile, int pcu\+\_\+profile, int $\ast$freq\+\_\+bands=\+N\+U\+L\+L)}]{\setlength{\rightskip}{0pt plus 5cm}{\bf P\+C\+M\+::\+Error\+Code} P\+C\+M\+::program\+Server\+Uncore\+Power\+Metrics (
\begin{DoxyParamCaption}
...
\subsubsection[{Q\+O\+S\+Metric\+Available()}]{\setlength{\rightskip}{0pt plus 5cm}bool P\+C\+M\+::\+Q\+O\+S\+Metric\+Available (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}\label{classPCM_a980d29a56d1a92505a5262d172a471c2}
...
\subsubsection[{reset\+P\+M\+U()}]{\setlength{\rightskip}{0pt plus 5cm}void P\+C\+M\+::reset\+P\+MU (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
If there is no chance to free up P\+MU from other applications you might try to call this method at your own risk. 

References is\+Core\+Online(), L3\+Q\+O\+S\+Metric\+Available(), and Q\+O\+S\+Metric\+Available().
